...
include "settings/class.upload.php";
$komisyon = 1.003;
kullanicikontrol();
?>
                            ...
                            <div class="row">
                                <div class="small-12 medium-2 large-2 columns">
                                    <div class="circle">
                                        ...
                                        <!-- User Profile Image -->
                                        <div class="col-md-12">
                                            <a href="assets/images/projects/project.jpg" data-plugin-lightbox
                                               data-plugin-options='{ "type":"image" }' title="">
                                                <img name="kullanici_resim" id="kullanici_resim"
                                        ...
                                        <div class="col-md-12">
                                            <button type="button" name="profil_resim_kaydet_btn"
                                                    id="profil_resim_kaydet_btn" class="btn btn-primary btn-block">
                                                KAYDET
                                            </button>
                                        </div>
                                    </div>
