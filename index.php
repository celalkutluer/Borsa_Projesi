                        ...
                        <table class="table table-bordered table-striped table-sm mb-0">
                            ...
                            for ($sayi = 99; $sayi > 94; $sayi--) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><i id="hisse_yukselen_durum_<?php echo $sayi; ?>" class="<?php
                                        ...
                                        ?>"></i></td>
                                    <td class="text-center" id="hisse_yukselen_son_deger_<?php echo $sayi; ?>"><?php echo $sorted[$sayi][2]; ?></td>
                                    <td class="text-center" id="hisse_yukselen_fark_<?php echo $sayi; ?>"><?php echo $sorted[$sayi][1]; ?></td>
                                </tr>
                            <?php } ?>
                            </tbody>
                        </table>
                            ...
                            for ($sayi = 0; $sayi < 5; $sayi++) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><i id="hisse_dusen_durum_<?php echo $sayi; ?>" class="<?php
                                        ...
                                        ?>"></i></td>
                                    <td class="text-center" id="hisse_dusen_son_deger_<?php echo $sayi; ?>"><?php echo $sorted[$sayi][2]; ?></td>
                                    <td class="text-center" id="hisse_dusen_fark_<?php echo $sayi; ?>"><?php echo $sorted[$sayi][1]; ?></td>
                                </tr>
                            <?php } ?>
                            </tbody>
                        </table>
